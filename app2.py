...
def aud_summarize2():
    audio_summarized = summarize2(text)
...
with gr.Blocks() as demo:
    ...
    greet_btn = gr.Button("(state)")
    greet_btn.click(fn=print_state, inputs=[], outputs=output_text)
        

    output_text = gr.Textbox(label="Summary 2:")
    greet_btn = gr.Button("Get Summary 2(text)")
    greet_btn.click(fn=print_text, inputs=[], outputs=output_text)
